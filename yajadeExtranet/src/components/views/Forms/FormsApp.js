...
componentDidMount() {
  ...
  handleSubmit = (e) => {
    ...
    console.log(data)
    this.props.dispatch({
      type: YajadeActionTypes.AddApp,
      data
    });
    axios.post('http://localhost:8081/addapp', data)//'http://172.17.0.1:8081/doc
      .then(res => {
      ...
      <Row>
        <Col xs="12">
          <Fade timeout={this.state.timeout} in={this.state.fadeIn}>
            <Card>
              <CardHeader>
                <i className="fa fa-edit"></i>Nouvelle application
                          </CardHeader>
              <CardBody>
                <Form className="form-horizontal" onSubmit={this.handleSubmit} >
                  <FormGroup>
                    ...
                    <div className="controls">
                      <InputGroup className="input-prepend">
                        <input id="prependedInput" className="form-control" size="16" type="text" ref={(input) => this.getLien = input} />
                      </InputGroup>
                  ...
                  <FormGroup>
                    ...
                    <div className="controls">
                      <InputGroup className="input-prepend">
                        <input id="prependedInput" className="form-control" size="16" type="text" ref={(input) => this.getImageLien = input} />
                      </InputGroup>
                  ...
                  <FormGroup>
                    ...
                    <div className="controls">
                      <InputGroup>
                        <input id="appendedInput" className="form-control" size="16" type="text" ref={(input) => this.getTitle = input} />
                      </InputGroup>
                  ...
                  <FormGroup>
                    ...
                    <div className="controls">
                      <InputGroup>
                        <input id="appendedInput" className="form-control" size="16" type="text" ref={(input) => this.getClient = input} />
                      </InputGroup>
                    </div>
                  </FormGroup>
                  <FormGroup>
                    ...
                    <div className="controls">
                      <InputGroup>
                        <input id="appendedInput" className="form-control" size="16" type="text" ref={(input) => this.getSaison = input} />
                      </InputGroup>
                    </div>
                  </FormGroup>
                  <FormGroup>
                    ...
                    <div className="controls">
                      <InputGroup>
                        <input id="appendedInput" className="form-control" size="16" type="text" ref={(input) => this.getPrix = input} />
                      </InputGroup>
                    </div>
                  </FormGroup>
                  <FormGroup>
                    ...
                    <div className="controls">
                      <InputGroup className="input-prepend">
                        ...
                        <textarea type="textarea" className="form-control textarea" id="textarea-input" rows="9" ref={(input) => this.getDescription = input} />
...
export default connect()(FormsApp);